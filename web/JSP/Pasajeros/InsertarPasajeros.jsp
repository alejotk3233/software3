<%-- 
    ...
    Created on : 18/11/2016, 05:12:40 PM
    Author     : MIGUEL 19
--%>
    ...
    <body>
        <%
            ...
            try{
                 ...
                 String Consulta ="insert into Pasajero (Nombre,Apellido,Tipo_Documento,Num_Documento,Fecha_Nacimiento,IdPais,Telefono,Email)" + 
